          ...
          <div className="mb-6 md:mb-0 ">
            <div className="rounded-lg shadow-xl card image-full">
              ...
              <div className="card-body justify-end">
                <h2 className="card-title mt-80">{name}</h2>
                <p>{login}</p>
              </div>
            </div>
          </div>
          <div className="col-span-2">
            <div className="mb-6">
              <h1 className="text-3xl card-title">
                {name}
                <div className="ml-2 mr-1 badge badge-success text-white">
                  {type}
                </div>
                <div>
                  {hireable && (
                    <div className="mx-1 badge badge-info text-white">
                      Hireable{' '}
                    </div>
                  )}
                </div>
            ...
            <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
              <div className="stat">
                ...
                <div className="stat-figure text-secondary">
                  ...
                  <div className="stat-title pr-5"> Pulic Repos</div>
                  <div className="stat-value pr-5 text-3xl md:text-3xl">
                    {' '}
                    {public_repos}
                  </div>
